...
public class Jury 
{
	...
	// Permet de récupérer la salle du Jury
	public int getSalle()	{ return this.salle; }

	// Permet de récupérer la date du Jury
	public String getDate()	{ return this.date; }

	// Permet de récupérer l'heure de commencement du Jury
	public String getDebut()	{ return this.debut; }

	// Permet de récupérer l'heure de fin du Jury
	public String getFin()	{ return this.fin; }

	// Permet de récupérer le nombre de groupes que peut évaluer le jury sur son crénau
	public int getNbPassage()	{ return this.nbPassage; }

	public ArrayList<String> getTabEnseignant() { return this.enseignant; }

	// Permet de récupérer les enseignants du jury
